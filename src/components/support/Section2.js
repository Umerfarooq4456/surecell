    ...
    <>
      <div className="section2support">
        <div className="basis">
          ...
          <p className="basis-para1">75 trained emergency response agents</p>
        </div>
        ...
        <div className="basis">
          ...
          <p className="basis-para1">Lasts up to 18 months</p>
        </div>
        ...
        <div className="basis">
          ...
          <p className="basis-para1">Small enough to wear on your wrist</p>
        </div>
        ...
        <div className="basis">
          ...
          <p className="basis-para1">
            Wear it all the time, even in the shower
          </p>
        </div>
      </div>
      <div className="emergency">
        <p className="USA-text">
          Our emergency dispatchers are based only in the USA
        </p>
      </div>
    </>
  );
